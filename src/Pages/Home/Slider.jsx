...
<SwiperSlide>
    <div className="relative h-[380px] md:h-[450px] flex" style={{ background: "#1E3A8A" }}>
        <div className="w-1/2 flex flex-col justify-center px-8 md:px-14 z-10">
            ...
            <button className="mt-5 text-white text-sm font-semibold px-5 py-2.5 rounded-lg shadow-md hover:opacity-90 transition" style={{ background: "#2563EB" }}>
                Shop Basin Items
            </button>
        </div>
...
<SwiperSlide>
    <div className="relative h-[380px] md:h-[450px] flex" style={{ background: "#065F46" }}>
        <div className="w-1/2 flex flex-col justify-center px-8 md:px-14 z-10">
            ...
            <button className="mt-5 text-white text-sm font-semibold px-5 py-2.5 rounded-lg shadow-md hover:opacity-90 transition" style={{ background: "#10B981" }}>
                Explore Kitchen
            </button>
        </div>
        <div className="w-1/2 h-full relative">
...
<SwiperSlide>
    <div className="relative h-[380px] md:h-[450px] flex" style={{ background: "#7C2D12" }}>
        <div className="w-1/2 flex flex-col justify-center px-8 md:px-14 z-10">
            ...
            <button className="mt-5 text-white text-sm font-semibold px-5 py-2.5 rounded-lg shadow-md hover:opacity-90 transition" style={{ background: "#EA580C" }}>
                View Pipes
            </button>
        </div>
        <div className="w-1/2 h-full relative">
...
<SwiperSlide>
    <div className="relative h-[380px] md:h-[450px] flex" style={{ background: "#312E81" }}>
        <div className="w-1/2 flex flex-col justify-center px-8 md:px-14 z-10">
            ...
            <button className="mt-5 text-white text-sm font-semibold px-5 py-2.5 rounded-lg shadow-md hover:opacity-90 transition" style={{ background: "#6366F1" }}>
                Browse Showers
            </button>
        </div>
        <div className="w-1/2 h-full relative">
...
<SwiperSlide>
    <div className="relative h-[380px] md:h-[450px] flex" style={{ background: "#78350F" }}>
        <div className="w-1/2 flex flex-col justify-center px-8 md:px-14 z-10">
            ...
            <button className="mt-5 text-white text-sm font-semibold px-5 py-2.5 rounded-lg shadow-md hover:opacity-90 transition" style={{ background: "#F59E0B" }}>
                See Accessories
            </button>
        </div>
        <div className="w-1/2 h-full relative">
