...
const PRIORITIES = [
  { value: "low", label: "Low", emoji: "🟢", desc: "Minor issue, not urgent", color: "border-green-400 bg-green-50 text-green-700" },
  { value: "medium", label: "Medium", emoji: "🟡", desc: "Affects workflow a bit", color: "border-yellow-400 bg-yellow-50 text-yellow-700" },
  { value: "high", label: "High", emoji: "🔴", desc: "Blocking work!", color: "border-red-400 bg-red-50 text-red-700" },
];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-8">
        <div className="max-w-3xl mx-auto flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-gray-500 text-lg mt-1">Found something broken? Tell us! We'll squash it faster than you can say "wrench" 🔧</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-7">
          ...
          <p className="text-gray-500 text-base mb-6">So we know who to thank (or blame 😄)</p>
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-7">
          ...
          <p className="text-gray-500 text-base mb-6">Pick the priority level honestly — don't panic over a typo!</p>
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-7">
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              rows={4}
              placeholder="Describe what went wrong. Be as detailed as you want — we love details! 🤓"
        ...
        <p className="text-center text-gray-400 text-base pb-6">
          BuildMart Hardware · Bug Tracker · Thanks for keeping the system clean! 🧹
        </p>
      </div>
    </div>
  );
